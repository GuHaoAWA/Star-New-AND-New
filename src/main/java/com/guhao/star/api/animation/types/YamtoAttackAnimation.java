...
public class YamtoAttackAnimation extends AttackAnimation {
    ...
    public YamtoAttackAnimation(float convertTime, float attackstart, float attackend, float attackwinopen, float attackwinclose, float skillwinopen, float skillwinclose, float lockon, float lockoff, String path, Armature armature, Phase... phases) {
